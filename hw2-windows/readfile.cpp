            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
						...
						std::cout << "Camera set to " << values[0] << "-" << values[1] << "-" << values[2] << std::endl;
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
						...
						mat3 rotation = Transform::rotate(values[3], vec3(values[0], values[1], values[2]));
						mat4 rotationToPush = mat4(rotation[0][0], rotation[0][1], rotation[0][2], 0,
												rotation[1][0], rotation[1][1], rotation[1][2], 0,
												rotation[2][0], rotation[2][1], rotation[2][2], 0, 
												0, 0, 0, 1);

						rightmultiply(rotationToPush, transfstack);
						obj->transform = transfstack.top();
						glUniformMatrix4fv(modelviewPos, 1, GL_FALSE, &(modelview)[0][0]);
                    }
                }
